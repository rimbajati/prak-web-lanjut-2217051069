        ...
        <div class="card p-4" style="width: 30rem;">
            ...
            <form action="{{ route('user.update', $user['id']) }}}}" method="POST" enctype="multipart/form-data"> 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="nama" name="nama" class="form-control" value="{{ old('nama', $user->nama) }}" placeholder="Nama Anda">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="npm" name="npm" class="form-control" value="{{ old('npm', $user->npm) }}" placeholder="NPM Anda">
                ...
                <div class="mb-3">
                    ...
                    @if ($user->foto)
                    <img src="{{ asset('assets/upload/img/' . $user->foto) }}" alt="Foto User" width="100">
                    @endif
                </div>
